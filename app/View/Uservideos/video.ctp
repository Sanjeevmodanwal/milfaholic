                    ...
                    <div class="col-sm-9">
                        <div class="sidebar_right">
                          ...
                          <div class="profile_new">
                            ...
                            <div class="col-sm-12">
                              <?php echo $this->Form->create('Uservideo',array('controller' => 'Users', 'action' => 'editprofile/', $id ,'type'=>'file'));?>
                            	...
                            	<div class="pro_info">
                                	<ul>
                                    	<li>
                                            <h3>Photo Manager: 
                                                <?php echo $this->Form->input('video',array('type'=>'file','label'=>FALSE,'div'=>FALSE,'class'=>'profile_photo'));?></h3>
