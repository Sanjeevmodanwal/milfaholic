<div class="plans index">
	...
	<tr>
		...
		<td><?php echo h($plan['Plan']['time']); ?>&nbsp;</td>
		<td><?php echo h($plan['Plan']['price']); ?>&nbsp;</td>
		<td><?php echo h($plan['Plan']['status']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $plan['Plan']['id']), array(), __('Are you sure you want to delete # %s?', $plan['Plan']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
