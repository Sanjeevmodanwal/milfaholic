<div class="staticpages index">
	...
	<tr>
		...
		<td><?php echo h($staticpage['Staticpage']['image']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $staticpage['Staticpage']['id']), array(), __('Are you sure you want to delete # %s?', $staticpage['Staticpage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
